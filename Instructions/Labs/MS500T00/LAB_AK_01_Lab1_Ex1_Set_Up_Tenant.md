...
19. In the left navigation pane, select **Settings** and then select **Settings** again then select **Organization profile** tab.
...
25. In the **Release preferences** window, select **Targeted release for selected users** and then select **Save changes**.  
...
28. In the **Choose users for targeted release** window, in the list of users, select the **MOD Administrator** and then select **Save changes**.

29. Select **Close**, this returns you to the **Settings** window.
...
32. Once you’re done exploring and making any further changes, select **Save changes** and then **Close**.
...
1. You should still be logged into your Client 1 VM as the **lon-cl1\admin** account with password = **Pa55w.rd**, and you should be logged into Microsoft 365 (portal.office.com) as **Holly Dickson**. 
